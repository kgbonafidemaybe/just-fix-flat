  ...
  return (
    <section className="py-12 bg-slate-100">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-10">Our Most Requested Services</h2>
          ...
          {services.map((service, index) => (
            <Card key={index} className="border-none shadow-lg overflow-hidden">
              <CardContent className={`p-0 flex flex-col items-center ${service.bgColor} aspect-square relative`}>
                ...
                <div className="absolute bottom-0 w-full bg-white py-2 px-1 text-center">
